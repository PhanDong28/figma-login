    ...
    <div>
      ...
      <div className="form1 flex flex-col items-start gap-4 order-0">
        ...
        <div className="flex flex-row items-start p-0 gap-40 order-2 w-full">
            ...
            <p onClick={forgetPassword} className="forgot font-serif font-normal text-base leading-7 text-[#3A57E8] order-0 cursor-pointer hover:text-[#131c49]">Forgot Password</p>
        </div>
      </div>
