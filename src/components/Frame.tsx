    ...
    <div>
      ...
      <div className="form1 flex flex-col items-start gap-4 order-0">
        <div className="flex flex-col items-start gap-2 order-0">
            ...
            <label htmlFor="username" className="username flex flex-col items-start gap-4 order-1 w-96 h-11 ">
                <input type="text" className="username border-solid rounded-md border-[1px] border-box px-4 py-2 gap-56 w-96 h-11 bg-[#FFFF] order-0 border-[#3A57E8] focus:bg-blue-100 hover:bg-blue-100 focus:outline-none" />
            </label>
        </div>
        <div className="flex flex-col items-start gap-2 order-0">
            <h1 className="password font-serif font-normal text-base leading-7 text-[#8A92A6] order-0">Password</h1>
            <label htmlFor="password" className="password flex flex-col items-start gap-4 order-1 w-96 h-11 ">
                <input type="password" className="password border-solid rounded-md border-[1px] border-box px-4 py-2 gap-56 w-96 h-11 bg-[#FFFF] order-0 border-[#3A57E8] focus:bg-blue-100 hover:bg-blue-100 focus:outline-none" />
            </label>
        </div>
        <div className="flex flex-row items-start p-0 gap-40 order-2">
